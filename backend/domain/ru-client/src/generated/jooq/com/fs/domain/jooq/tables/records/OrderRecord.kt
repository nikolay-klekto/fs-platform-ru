...
open class OrderRecord() : UpdatableRecordImpl<OrderRecord>(Order.ORDER), Record11<Long?, Long?, Long?, Long?, Long?, Boolean?, LocalDateTime?, Long?, Double?, OrderStatus?, LocalDateTime?> {
    ...
    var orderStatus: OrderStatus?
        ...
        get(): OrderStatus? = get(9) as OrderStatus?
    ...
    override fun valuesRow(): Row11<Long?, Long?, Long?, Long?, Long?, Boolean?, LocalDateTime?, Long?, Double?, OrderStatus?, LocalDateTime?> = super.valuesRow() as Row11<Long?, Long?, Long?, Long?, Long?, Boolean?, LocalDateTime?, Long?, Double?, OrderStatus?, LocalDateTime?>
    ...
    override fun field10(): Field<OrderStatus?> = Order.ORDER.ORDER_STATUS
    override fun field11(): Field<LocalDateTime?> = Order.ORDER.DATE_CREATED
    ...
    override fun component10(): OrderStatus? = orderStatus
    override fun component11(): LocalDateTime? = dateCreated
    ...
    override fun value10(): OrderStatus? = orderStatus
    override fun value11(): LocalDateTime? = dateCreated
    ...
    override fun value10(value: OrderStatus?): OrderRecord {
        this.orderStatus = value
        return this
    }

    override fun value11(value: LocalDateTime?): OrderRecord {
        this.dateCreated = value
        return this
    }

    override fun values(value1: Long?, value2: Long?, value3: Long?, value4: Long?, value5: Long?, value6: Boolean?, value7: LocalDateTime?, value8: Long?, value9: Double?, value10: OrderStatus?, value11: LocalDateTime?): OrderRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(id: Long? = null, basketId: Long? = null, companyOfficeId: Long? = null, positionId: Long? = null, serviceId: Long? = null, isExpired: Boolean? = null, startWorkDate: LocalDateTime? = null, totalWorkDays: Long? = null, price: Double? = null, orderStatus: OrderStatus? = null, dateCreated: LocalDateTime? = null): this() {
        this.id = id

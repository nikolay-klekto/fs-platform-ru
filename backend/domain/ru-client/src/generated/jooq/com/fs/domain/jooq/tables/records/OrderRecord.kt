...
open class OrderRecord() : UpdatableRecordImpl<OrderRecord>(Order.ORDER), Record12<Long?, Long?, Long?, Boolean?, LocalDateTime?, Long?, Double?, String?, LocalDateTime?, Long?, String?, Long?> {
    ...
    override fun valuesRow(): Row12<Long?, Long?, Long?, Boolean?, LocalDateTime?, Long?, Double?, String?, LocalDateTime?, Long?, String?, Long?> = super.valuesRow() as Row12<Long?, Long?, Long?, Boolean?, LocalDateTime?, Long?, Double?, String?, LocalDateTime?, Long?, String?, Long?>
    ...
    override fun field11(): Field<String?> = Order.ORDER.CONTRACT_NUMBER
    override fun field12(): Field<Long?> = Order.ORDER.ORDER_DATES_ID
    ...
    override fun component11(): String? = contractNumber
    override fun component12(): Long? = orderDatesId
    ...
    override fun value11(): String? = contractNumber
    override fun value12(): Long? = orderDatesId
    ...
    override fun value11(value: String?): OrderRecord {
        this.contractNumber = value
        return this
    }

    override fun value12(value: Long?): OrderRecord {
        this.orderDatesId = value
        return this
    }

    override fun values(value1: Long?, value2: Long?, value3: Long?, value4: Boolean?, value5: LocalDateTime?, value6: Long?, value7: Double?, value8: String?, value9: LocalDateTime?, value10: Long?, value11: String?, value12: Long?): OrderRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(id: Long? = null, basketId: Long? = null, companyOfficeId: Long? = null, isExpired: Boolean? = null, startWorkDate: LocalDateTime? = null, totalWorkDays: Long? = null, price: Double? = null, orderStatus: String? = null, dateCreated: LocalDateTime? = null, companyProfessionId: Long? = null, contractNumber: String? = null, orderDatesId: Long? = null): this() {
        this.id = id
        ...
        this.orderDatesId = orderDatesId
    }
    ...
    constructor(value: com.fs.domain.jooq.tables.pojos.Order?): this() {
        if (value != null) {
            ...
            this.orderDatesId = value.orderDatesId
        }
    }
}

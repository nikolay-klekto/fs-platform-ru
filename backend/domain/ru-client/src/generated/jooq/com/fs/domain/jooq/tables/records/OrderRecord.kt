...
open class OrderRecord() : UpdatableRecordImpl<OrderRecord>(Order.ORDER), Record11<Long?, Long?, Long?, Boolean?, LocalDateTime?, Long?, Double?, String?, LocalDateTime?, Long?, String?> {
    ...
    override fun valuesRow(): Row11<Long?, Long?, Long?, Boolean?, LocalDateTime?, Long?, Double?, String?, LocalDateTime?, Long?, String?> = super.valuesRow() as Row11<Long?, Long?, Long?, Boolean?, LocalDateTime?, Long?, Double?, String?, LocalDateTime?, Long?, String?>
    ...
    override fun values(value1: Long?, value2: Long?, value3: Long?, value4: Boolean?, value5: LocalDateTime?, value6: Long?, value7: Double?, value8: String?, value9: LocalDateTime?, value10: Long?, value11: String?): OrderRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(id: Long? = null, basketId: Long? = null, companyOfficeId: Long? = null, isExpired: Boolean? = null, startWorkDate: LocalDateTime? = null, totalWorkDays: Long? = null, price: Double? = null, orderStatus: String? = null, dateCreated: LocalDateTime? = null, companyProfessionId: Long? = null, contractNumber: String? = null): this() {
        this.id = id

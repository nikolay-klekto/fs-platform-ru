...
import com.fs.auth.jooq.keys.ORDER_PKEY
import com.fs.auth.jooq.keys.ORDER__ORDER_BASKET_ID_FKEY
import com.fs.auth.jooq.keys.ORDER__ORDER_COMPANY_PROFESSION_ID_FKEY
...
open class Order(
    ...
    override fun getReferences(): List<ForeignKey<OrderRecord, *>> = listOf(ORDER__ORDER_BASKET_ID_FKEY, ORDER__ORDER_COMPANY_PROFESSION_ID_FKEY)

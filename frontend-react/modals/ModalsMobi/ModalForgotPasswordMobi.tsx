...
const ModalForgotPasswordMobi: React.FC<IModalContent> = ({ onClose }) => {
    ...
    return (
        <Modal
            ...
            isMobile={isMobile}
            className={"bg-[url('/background/Subtract_modalCaForgotPass_png.png')] bg-[center] bg-no-repeat"}
        >
            <div className="relative w-[346px] sm:mx-2 sm_s:mx-3 py-[40px]" ref={modalRef}>
                <button
                    onClick={onClose}
                ...
                <div className="flex w-full flex-col pl-[13px] pr-[12px]">
                    <EnhancedInput
                        ...
                        className={`${inputTouched.email && validateEmailMobi(passwordData.email).styleError
                ...
                <button
                    ...
                    className={`mx-auto mb-2 mt-7 flex h-12 w-[85%] items-center justify-center rounded-[50px]  text-3xl font-semibold 
                        md:text-4xl ${!isSubmitted || isFormValid

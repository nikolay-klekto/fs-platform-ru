...
const ModalCallMobi: React.FC<IModalContent> = ({ onClose }) => {
    ...
    return (
        <Modal
            ...
            isMobile={isMobile}
            className={"bg-[url('/background/Subtract_modallCall_CallOrder2.png')] bg-[center] bg-no-repeat"}
        >
            {step === 'form' && (
                // <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black bg-opacity-[70%]">
                <div className="relative w-[340px] h-[490px] flex flex-col items-center justify-center ">
                    <button
                        onClick={onClose}
                    ...
                    <form className="flex flex-col items-start pl-2 pr-1" onSubmit={handleSubmit}>
                        <div className="mb-3 flex w-full flex-col p-0.5">
                            <EnhancedInput
                                ...
                                className={`border-2 ${inputTouched.name && validateNameMobi(formData.name).styleError
                                    ? 'border-[#bc8070]'
                                    : 'border-[#878797]'
                        ...
                        <button
                            ...
                            className={`bg-sub-title-gradient-mobi mx-auto mt-[30px] h-12 w-4/5 rounded-[50px] text-3xl font-semibold text-white md:text-4xl  ${Object.values(errors).some((err) => err?.trim())

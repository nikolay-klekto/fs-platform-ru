...
export default function ModalCookieMobi({ onClose }: IModalCookieMobi) {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogPortal>
                <div className="fixed bottom-0 sm_xl:right-0 md:right-0 gap-[18px] z-50 box-border flex h-[128px] max-w-[375px] flex-col justify-between items-center overflow-hidden rounded-[25px] border border-transparent bg-[#101030E6] px-3 shadow-lg drop-shadow-2xl font-medium">
                    <div className="break-words text-xs text-center leading-snug text-white pt-4">

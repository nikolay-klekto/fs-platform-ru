...
export default function ModalCookieMobi({ onClose }: IModalCookieMobi) {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogPortal>
                <DialogPrimitive.Content className="modal-position-cookie-mobi modal-size-cookie-mobi box-border flex flex-col justify-between overflow-hidden border border-transparent bg-[#101030E6] shadow-lg drop-shadow-2xl duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-right-4 data-[state=closed]:slide-out-to-bottom-4 data-[state=open]:slide-in-from-right-4 data-[state=open]:slide-in-from-bottom-4 sm:rounded-lg">

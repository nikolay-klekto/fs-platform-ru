            ...
            <div className=" flex max-w-[578px] flex-col">
                ...
                <div className="flex w-full flex-col px-[76px]">
                    ...
                    <EnhancedInput
                        ...
                        }  h-13 palceholder:pl-[20px] w-full max-w-[426px] rounded-[50px] border-2 bg-transparent pl-[20px] text-4xl font-medium opacity-80 placeholder:text-[#353652]/40 focus:ring-0 focus:ring-offset-0`}
                        label="Почта"

                    ...
                    <div className="relative flex flex-col gap-1 rounded-[42px] bg-[#1F203F] p-3">
                        <div className="custom-grey flex items-center justify-between">
                            <div className="relative flex flex-col" ref={fromCalendarRef}>
                                <p>От</p>
                                <div
<<<<<<< HEAD:frontend-react/components/desktop/pageDesktop/EventsPageDesktop/components/EventsSelectSearchDateDesctop.tsx
...
>>>>>>> origin/dev-front-react:frontend-react/components/desktop/pageDesktop/EventsPageDesktop/components/EventsSelectSearchDateDesktop.tsx

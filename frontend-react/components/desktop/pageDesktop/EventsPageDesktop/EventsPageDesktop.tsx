        ...
        <>
            ...
            <main className="bg-[#101030] text-white">
                <div className="container relative min-h-screen overflow-hidden p-[76px_212px_88px_212px] 2xl:p-[60px_130px_88px_130px] 3xl:p-[76px_230px_150px_230px] 4xl:p-[76px_290px_150px_290px]">
                    ...
                    <div className={`flex w-full flex-col ${isEmpty ? 'gap-[17px]' : 'gap-[73px]'}`}>
                        {isEmpty ? (
                            ...
                            <div className="grid min-h-[40vh] grid-cols-3 2xl:justify-items-center 2xl:grid-cols-2 3xl:justify-items-center 3xl:grid-cols-2 4xl:grid-cols-2 gap-[36px] 2xl:gap-[20px] 3xl:gap-[25px] 4xl:gap-[30px]">

    ...
    return (
        <>
            ...
            <main className="flex justify-center overflow-hidden bg-[#101030] text-white">
                <div className="3xl:p-[76px_130px_150px_130px] relative min-h-screen max-w-[1920px] overflow-x-visible p-[76px_212px_200px_212px] 2xl:p-[60px_100px_100px_100px]">

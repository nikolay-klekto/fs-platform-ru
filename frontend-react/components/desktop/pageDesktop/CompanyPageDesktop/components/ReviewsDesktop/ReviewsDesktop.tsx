...
import { contentReviewsDesktop } from '../../contentCompanyPageDesktop/content'
    ...
    return (
        <div>
            ...
            <div
                ...
                className="scrollbar_custom relative mx-auto mt-[clamp(25px,_2vw,_40px)] mb-[132px] h-[14px] w-[65%] cursor-pointer overflow-x-scroll"
            >

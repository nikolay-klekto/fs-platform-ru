            ...
            >
                ...
                <div className="relative w-full max-w-[1800px] justify-between flex items-center z-10 border border-red-500 border-solid">
                    ...
                    <div className="flex gap-[50px] 4xl:gap-[1.5vw] 3xl:gap-[20px] 2xl:gap-[1.5vw] xl:gap-[1.5vw] lg:gap-[1.5vw]">
                        <ShoppingCartIcon className="flex-shrink-0 w-[50px] h-[50px] 4xl:w-[40px] 4xl:h-[40px] 3xl:w-[36px] 3xl:h-[36px] 2xl:w-[30px] 2xl:h-[30px] xl:w-[24px] xl:h-[24px] lg:w-[20px] lg:h-[20px]" />
                        <ProfileIcon className="flex-shrink-0 w-[50px] h-[50px] 4xl:w-[40px] 4xl:h-[40px] 3xl:w-[36px] 3xl:h-[36px] 2xl:w-[30px] 2xl:h-[30px] xl:w-[24px] xl:h-[24px] lg:w-[20px] lg:h-[20px]" />
                    </div>
                </div>
            </header>
        </>

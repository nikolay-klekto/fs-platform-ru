    ...
    return (
        <div className="pb-[30px]">
            <div className="relative min-h-[454px] min-w-[520px]">
                ...
                <div className="absolute right-[23px] top-[18px] w-[114px] h-[101px] rounded-[23px] bg-white bg-opacity-90 flex flex-col justify-center items-center">
                    <p className="text-9xl font-semibold text-[#1f203f]">{day}</p>
                    <p className="text-4xl font-medium text-[#878797]">{month}</p>
                </div>
            </div>
            <p className="uppercase text-9xl font-medium text-white pt-5">{title}</p>
        </div>
    )
}

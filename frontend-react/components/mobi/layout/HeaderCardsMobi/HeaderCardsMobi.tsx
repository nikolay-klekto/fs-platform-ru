    ...
    return (
        <>
            <div className="sm_l:max-w-[95vw] sm_l:p-[0.5vw] m-auto flex max-w-[374px] flex-col gap-[20px] p-[14px] sm:px-[4vw] sm:w-auto">
                {content.map((item) => (
                    <div
                        className="flex min-h-[212px] flex-1 flex-col items-center justify-center gap-[30px] bg-[url('/background/subtract_mobi.svg')] bg-contain bg-no-repeat px-[30px] drop-shadow-[0_3.26px_3.26px_rgba(0,0,0,0.25)] sm:min-h-[180px] sm_s:min-h-[194px] sm_s:mx-[0vw] "
                        key={item.id}
                    >

...
export const AccountNavigationMobi: React.FC = () => {
    ...
    return (
        <div className="text-text22px_mobi relative  text-[#878797]">
            <button
                className="bg-sub-title-gradient-mobi flex items-center bg-clip-text pb-[40px] text-4xl uppercase text-transparent underline decoration-[#6C41F3] decoration-1 underline-offset-4"

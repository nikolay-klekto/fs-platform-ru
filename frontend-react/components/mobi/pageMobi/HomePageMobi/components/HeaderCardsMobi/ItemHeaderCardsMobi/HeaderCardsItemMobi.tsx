...
const HeaderCardsItemMobi: React.FC<IHeaderCardItem> = ({
    ...
    return (
        <>
            <div
                className="md:p-[55px] sm_s:min-h-[192px] relative sm_xl:h-[226px] sm_xl:w-fit m-auto flex min-h-[212px] w-[346px] flex-col items-center justify-center rounded-[41px] drop-shadow-[0_3.26px_3.26px_rgba(0,0,0,0.25)] sm:min-h-[176px]"
                style={{
            ...
            >
                ...
                <div className="flex h-full w-full flex-col items-center gap-[17px]">
                    <div className="flex h-full flex-col items-center justify-between text-center">
                        <div className="sm_s:text-3xl sm_s:leading-[24px] md:text-11xl px-[30px] text-justify text-5xl font-medium leading-[32px] text-white sm:text-3xl sm:leading-[24px]">
                            {textBlack}{' '}

    ...
    variants: {
        ...
        size: {
            ...
            profession_home_mobi:
                'aspect-[5/6] md:w-[600px] w-[320px] p-[20px] sm:w-[260px] sm_s:w-[280px] sm_l:w-[300px] sm_xl:w-[320px]',
            profession_page_desktop:
...
const cardTitleVariants = cva('font-medium', {
    variants: {
        variant: {
            ...
            profession_home_mobi:
                'md:text-[42px] text-[22px] bg-white bg-opacity-[70%] font-semibold tracking-normal text-[#101030]',
            profession_page_desktop:

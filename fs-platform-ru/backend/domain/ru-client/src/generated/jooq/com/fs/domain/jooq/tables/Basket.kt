...
open class Basket(
     ...
     */
    val TOTAL_PRICE: TableField<BasketRecord, String?> =
        createField(DSL.name("total_price"), SQLDataType.VARCHAR, this, "")

    private constructor(alias: Name, aliased: Table<BasketRecord>?) : this(alias, null, null, aliased, null)
    private constructor(alias: Name, aliased: Table<BasketRecord>?, parameters: Array<Field<*>?>?) : this(
        alias,
        null,
        null,
        aliased,
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, BasketRecord>) : this(

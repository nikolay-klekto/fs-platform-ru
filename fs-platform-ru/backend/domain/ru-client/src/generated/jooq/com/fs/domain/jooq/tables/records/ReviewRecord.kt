...
open class ReviewRecord() : UpdatableRecordImpl<ReviewRecord>(Review.REVIEW), Record7<Long?, Long?, Long?, LocalDateTime?, String?, Long?, String?> {
    ...
    override fun valuesRow(): Row7<Long?, Long?, Long?, LocalDateTime?, String?, Long?, String?> = super.valuesRow() as Row7<Long?, Long?, Long?, LocalDateTime?, String?, Long?, String?>
    ...
    override fun values(value1: Long?, value2: Long?, value3: Long?, value4: LocalDateTime?, value5: String?, value6: Long?, value7: String?): ReviewRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(id: Long? = null, companyId: Long? = null, clientId: Long? = null, dateCreated: LocalDateTime? = null, description: String? = null, rate: Long? = null, username: String? = null): this() {
        this.id = id
